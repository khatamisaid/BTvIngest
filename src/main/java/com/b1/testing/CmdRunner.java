...
public class CmdRunner implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                Role kontriRole = new Role(6, "Kontri", "Hak Akses Upload");
                roleRepository.save(adminRole);
                roleRepository.save(produserRole);
                roleRepository.save(editorRole);
                roleRepository.save(uploaderRole);
                roleRepository.save(libraryRole);
                roleRepository.save(kontriRole);
                personRepository
                                .save(new Person(1, "Administrator", encoder.encode("admin123"), "admin@it-berita1.com",
                                                adminRole));
                personRepository
                                .save(new Person(2, "Produser", encoder.encode("produser123"), "produser@berita1.com",
                                                produserRole));
                personRepository.save(
                                new Person(3, "Editor", encoder.encode("editor123"), "editor@berita1.com", editorRole));
                personRepository
                                .save(new Person(4, "Uploader", encoder.encode("uploader123"), "uploader@berita1.com",
                                                uploaderRole));
                personRepository
                                .save(new Person(5, "Library", encoder.encode("library123"), "library@berita1.com",
                                                libraryRole));
                personRepository
                                .save(new Person(6, "Kontri", encoder.encode("kontri123"), "kontri@berita1.com",
                                                kontriRole));
